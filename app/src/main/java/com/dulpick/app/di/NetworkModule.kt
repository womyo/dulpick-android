...
object NetworkModule {
    ...
    @Singleton
    @Authed
    fun homeApi(@Authed retrofit: Retrofit): HomeApi = retrofit.create(HomeApi::class.java)

    @Provides
    @Singleton
    @Authed
    fun placeImportApi(@Authed retrofit: Retrofit): PlaceImportApi =
        retrofit.create(PlaceImportApi::class.java)
